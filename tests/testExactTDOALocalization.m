...
verifyEqual(testCase, diagnostics.terminationReason, "converged");
...
verifyEqual(testCase, diagnostics.residualCount, 3);
verifyEqual(testCase, diagnostics.maximumAbsoluteResidualSeconds, ...
    max(abs(diagnostics.residualVectorSeconds)));
...
verifyEqual(testCase, metrics.terminationReason, ...
...
verifyEqual(testCase, metrics.maximumAbsoluteResidualSeconds, ...
